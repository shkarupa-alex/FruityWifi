...
<div class="rounded-bottom">
    ...
    <?
        if ($iface_wlan0mon == "") {
            echo "<b><a href='page_config.php?service=wlan0mon&action=start'>start</a></b> [<font color='red'>wlan0mon</font>]";
        } else {
            echo "<b><a href='page_config.php?service=wlan0mon&action=stop'>stop</a></b>&nbsp; [<font color='lime'>wlan0mon</font>]";
        }
